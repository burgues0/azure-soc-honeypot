# Script created by Josh Madakor, the instructor of the lab!
# I just removed the samples because in the newer versions of Azure I used the Log Queries to treat the data.
#
